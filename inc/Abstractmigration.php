...
abstract class WeArePlanetAbstractmigration
{
    const CK_DB_VERSION = 'PLN_DB_VERSION';
    ...
    public static function installDb()
    {
        try {
            ...
            PrestaShopLogger::addLog($e->getMessage(), 2, null, 'WeArePlanet');
        }
        return true;
    }
    ...
    protected static function installTableBase()
    {
        ...
        $result = $instance->execute(
            "CREATE TABLE IF NOT EXISTS " . _DB_PREFIX_ . "pln_method_configuration(
        ...
        $result = $instance->execute(
            "CREATE TABLE IF NOT EXISTS " . _DB_PREFIX_ . "pln_transaction_info(
        ...
        $result = $instance->execute(
            "CREATE TABLE IF NOT EXISTS " . _DB_PREFIX_ . "pln_token_info(
        ...
        $result = $instance->execute(
            "CREATE TABLE IF NOT EXISTS " . _DB_PREFIX_ . "pln_cart_meta(
        ...
        $result = $instance->execute(
            "CREATE TABLE IF NOT EXISTS " . _DB_PREFIX_ . "pln_order_meta(
                `order_id` int(10) unsigned NOT NULL,
                `meta_key` varchar(128) COLLATE utf8_unicode_ci NOT NULL,
                `meta_value` longtext COLLATE utf8_unicode_ci NULL,
        ...
        $result = $instance->execute(
            "CREATE TABLE IF NOT EXISTS " . _DB_PREFIX_ . "pln_void_job(
        ...
        $result = $instance->execute(
            "CREATE TABLE IF NOT EXISTS " . _DB_PREFIX_ . "pln_completion_job(
    ...
    {
        $authorizedStatus = WeArePlanetOrderstatus::getAuthorizedOrderStatus();
        $waitingStatus = WeArePlanetOrderstatus::getWaitingOrderStatus();
        $manualStatus = WeArePlanetOrderstatus::getManualOrderStatus();

        Configuration::updateGlobalValue(WeArePlanetBasemodule::CK_STATUS_FAILED, Configuration::get('PS_OS_ERROR'));
        Configuration::updateGlobalValue(WeArePlanetBasemodule::CK_STATUS_AUTHORIZED, $authorizedStatus->id);
        Configuration::updateGlobalValue(WeArePlanetBasemodule::CK_STATUS_VOIDED, Configuration::get(
            'PS_OS_CANCELED'
        ));
        Configuration::updateGlobalValue(WeArePlanetBasemodule::CK_STATUS_COMPLETED, $waitingStatus->id);
        Configuration::updateGlobalValue(WeArePlanetBasemodule::CK_STATUS_MANUAL, $manualStatus->id);
        Configuration::updateGlobalValue(
            WeArePlanetBasemodule::CK_STATUS_DECLINED,
            Configuration::get('PS_OS_CANCELED')
        );
        Configuration::updateGlobalValue(WeArePlanetBasemodule::CK_STATUS_FULFILL, Configuration::get(
            'PS_OS_PAYMENT'
        ));
    }
