...
class WeArePlanetModelVoidjob extends ObjectModel
{
    ...
    public static function isVoidRunningForTransaction($spaceId, $transactionId)
    {
        $result = DB::getInstance()->getValue(
            'SELECT id_void_job FROM ' . _DB_PREFIX_ . 'pln_void_job WHERE space_id = "' . (int) $spaceId .
    ...
    public static function loadNotSentJobIds()
    {
        ...
        $result = DB::getInstance()->query(
            'SELECT id_void_job FROM ' . _DB_PREFIX_ . 'pln_void_job WHERE state = "' . pSQL(self::STATE_CREATED) .
