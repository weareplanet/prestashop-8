...
class WeArePlanetModelCompletionjob extends ObjectModel
{
    ...
    public static function isCompletionRunningForTransaction($spaceId, $transactionId)
    {
        $result = DB::getInstance()->getValue(
            'SELECT id_completion_job FROM ' . _DB_PREFIX_ . 'pln_completion_job WHERE space_id = "' . (int) $spaceId .
    ...
    public static function loadNotSentJobIds()
    {
        ...
        $result = DB::getInstance()->query(
            'SELECT id_completion_job FROM ' . _DB_PREFIX_ . 'pln_completion_job WHERE (state = "' .
