 ...
 */
abstract class WeArePlanetWebhookOrderrelatedabstract extends WeArePlanetWebhookAbstract
{
    ...
    public function process(WeArePlanetWebhookRequest $request)
    {
        ...
        try {
            ...
            if (Validate::isLoadedObject($order)) {
                $ids = WeArePlanetHelper::getOrderMeta($order, 'mappingIds');
     ...
     * @return object
     */
    abstract protected function loadEntity(WeArePlanetWebhookRequest $request);
