...
class WeArePlanetOrderModuleFrontController extends ModuleFrontController
{
    public $ssl = true;
    ...
    protected function checkAvailablility(Cart $cart)
    {
        if ($cart->id_address_delivery == 0 || $cart->id_address_invoice == 0 || ! $this->module->active ||
            ...
            $this->context->cookie->pln_error = $this->module->l('Your session expired, please try again.', 'order');
