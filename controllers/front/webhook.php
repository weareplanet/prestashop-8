...
class WeArePlanetWebhookModuleFrontController extends ModuleFrontController
{
    ...
    public function postProcess()
    {
        ...
        $webhookService = WeArePlanetServiceWebhook::instance();
        ...
        try {
            ...
            $request = new WeArePlanetWebhookRequest($parsed);
            ...
            PrestaShopLogger::addLog($e->getMessage(), 3, null, 'WeArePlanetWebhookEntity');
            echo $e->getMessage();
            die();
        }
    }
